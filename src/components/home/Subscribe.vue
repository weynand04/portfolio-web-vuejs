          ...
          <v-col cols="12" md="6" offset-md="1">
            ...
            <v-list class="transparent">
              <v-list-item>
                ...
                <v-list-item-subtitle>WAMAERKABOR@GMAIL.COM</v-list-item-subtitle>
              </v-list-item>
              ...
              <v-list-item>
                ...
                <v-list-item-subtitle>WAUPNOR, BIAK KOTA</v-list-item-subtitle>
              </v-list-item>
              ...
              <v-list-item>
                ...
                <v-list-item-subtitle>555-789-1234</v-list-item-subtitle>
              </v-list-item>
            </v-list>
          </v-col>
        </v-row>
